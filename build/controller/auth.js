...
var _authentication = require("../database/models/authentication");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return (0, _authentication.signup)(name, email, password);
        case 4:
          user = _context.sent;
          res.status(_status["default"].CREATED).json({
        ...
        case 8:
          ...
          res.status(_status["default"].BAD_REQUEST).json({
